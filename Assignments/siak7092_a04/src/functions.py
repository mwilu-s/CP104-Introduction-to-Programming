...
def colour_combine(rgb_colour1, rgb_colour2):
    ...
    -------------------------------------------------------
    """
    if rgb_colour1.lower() == RED:
        if rgb_colour2.lower() == RED:
            rgb_colour = RED
        elif rgb_colour2.lower() == BLUE:
            rgb_colour = 'fuchsia'
        elif rgb_colour2.lower() == GREEN:
            rgb_colour = 'yellow'
        else:
            rgb_colour = 'Error'
    elif rgb_colour1.lower() == BLUE:
        if rgb_colour2.lower() == RED:
            rgb_colour = 'fuchsia'
        elif rgb_colour2.lower() == BLUE:
            rgb_colour = BLUE
...
def hoo_rah(number):
    """
    -------------------------------------------------------
    Determines whether a number is divisible by 2 and/or 7.
    Returns "Hoo" if the number is evenly divisble by 2
            "Rah" if the number is evenly divisble by 7
            "Hoo Rah" if the number is evenly divisble by both 2 and 7
            "Zip" if it is none of the above
    Use: division = hoo_rah(number)
    -------------------------------------------------------
    Parameters:
        number - a number (float)
    Returns:
        division - the outcome on whether the number is divisible
                    by 2 and/or 7 (str)
    ------------------------------------------------------
    """
